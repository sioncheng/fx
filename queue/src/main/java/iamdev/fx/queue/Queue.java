...
public class Queue implements Closeable {
    ...
    private Queue(File metaFile, File dataFile, int capacity) throws IOException {
    ...
    public static Queue create(String directory, int capacity) throws IOException {
        ...
        return new Queue(metaFile, dataFile, capacity);
    }
